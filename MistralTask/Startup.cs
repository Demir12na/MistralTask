...
using MistralTask.MistralTaskEfcRepo;
using MistralTask.MistralTaskEfcRepo.Repositories;
...
namespace MistralTask
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<MistralTaskDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("Default")));
